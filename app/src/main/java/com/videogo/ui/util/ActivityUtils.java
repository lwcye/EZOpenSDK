...
//        LogUtil.e("cqcity", String.valueOf(EZGlobalSDK.class.isInstance(EzvizApplication.getOpenSDK())));
//        LogUtil.e("cqcity", "AccessToken:" + LocalInfo.getInstance().getAccessToken());
//        LogUtil.e("cqcity", "EzvizAPI.platformType:" + EzvizAPI.platformType);
//        LogUtil.e("cqcity", "EZPlatformType.EZPlatformTypeGLOBALSDK:" + EZConstants.EZPlatformType.EZPlatformTypeGLOBALSDK);
//        LogUtil.e("cqcity", "LocalInfo.getInstance().getAreaDomain():" + LocalInfo.getInstance().getAreaDomain());
